...
urlpatterns = [
    ...
    # Admin: Teams
    path('admin/teams/', views.teams_list, name='teams_list'),
    path('admin/teams/new/', views.team_edit, name='team_new'),
    path('admin/teams/<int:team_id>/', views.team_edit, name='team_edit'),
    ...
    # Admin: Deleted items management
    path('admin/deleted/', views.deleted_items, name='deleted_items'),
